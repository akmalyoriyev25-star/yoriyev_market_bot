# -*- coding: utf-8 -*-
"""YORIYEV MARKET BOT - Professional version"""
...
BOT_USERNAME = os.environ.get("BOT_USERNAME", "Yoriyev_market_bot")  # Bot username
...
SABZAVOTLAR = [
    "Kartoshka", "Piyoz", "Sabzi", "Sholgʻom", "Bodring", "Pomidor", "Turp", "Rediska",
    "Chesnok", "Qalampir", "Baqlajon", "Qovoq", "Karam", "Brokkoli", "Gulkaram", "Lavlagi",
    "Selderey", "Ismaloq", "Petrushka", "Ukrop", "Rayhon", "Shivit", "Qatiq oʻsimlik", "Hul",
    "Noʻxat", "Mosh", "Loviya", "Bodom", "Yongʻoq", "Qovoqcha", "Patisson", "Bamya",
    "Rokambol", "Qizilcha", "Tarvuz", "Qovun"
]

MEVALAR = [
    "Olma", "Nok", "Banan", "Mandarin", "Apelsin", "Limon", "Greypfrut", "Anor", "Xurmo",
    "Uzum", "Gilos", "Olcha", "Shaftoli", "Oʻrik", "Ananas", "Kivi", "Mango", "Avakado",
    "Qulupnay", "Malina", "Smorodina", "Bektoshi", "Tut", "Jiyda", "Olxoʻri", "Shaptoli",
    "Behi", "Yeryongʻoq", "Pista", "Findiq", "Kakos", "Papayya", "Guvayva"
]
...
def require_subscription(func):
    ...
    def wrapper(update: Update, context: CallbackContext, *args, **kwargs):
        ...
        if check_subscription(context.bot, user_id):
            ...
            # Kanalga a'zo bo'lmaganlarga xabar chiqarish
...
def show_main_menu(update: Update, context: CallbackContext, edit: bool = False):
    ...
    if edit:
        update.callback_query.edit_message_text(
            "🏠 *Bosh menyu*", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(keyboard)
        )
    else:
        update.message.reply_text(
            "🏠 *Bosh menyu*", parse_mode="Markdown", reply_markup=InlineKeyboardMarkup(keyboard)
...
def order_address_receive(update: Update, context: CallbackContext):
    ...
    if ADMIN_ID:
        try:
            ...
            logger.info(f"Admin xabar yuborildi: {ADMIN_ID}")
        except Exception as e:
            logger.error(f"Admin xabar yuborishda xatolik: {e}")
...
def admin_contact(update: Update, context: CallbackContext):
    ...
    query.edit_message_text(
        ...
        f"Admin: @{os.environ.get('ADMIN_USERNAME', 'akmalyoriyev')}\n"
...
def callback_handler(update: Update, context: CallbackContext):
    ...
    # Kanal tekshirishni talab qiladigan callbacklar uchun
