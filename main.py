...
BIZ_HAQIMIZDA = os.getenv("BIZ_HAQIMIZDA", "https://t.me/biz_haqimizda_yoriyev_market")
HAMKORLAR = os.getenv("HAMKORLAR", "https://t.me/hamkorlarimiz_yoriyev_market")
...
def main():
    ...
    if RAILWAY_STATIC_URL:
        ...
        logger.info(f"Webhook rejimida ishga tushdi: {webhook_url}")
    else:
